...
class Wood(PrimitiveResource):
    """A :class:`~resources.base.PrimitiveResource.PrimitiveResource` produced by :class:`Units <core.basetypes.Unit.Unit>` such as :class:`~units.WoodGatherer.WoodGatherer`.
    
    Wood is used as a construction material of buildings and :class:`Compound Resources <resources.base.CompoundResource.CompoundResource>` such as :class:`Tools <resources.Tool.Tool>`
