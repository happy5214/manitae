...
class Food(PrimitiveResource):
    """A :class:`~resources.base.PrimitiveResource.PrimitiveResource` produced by :class:`Units <core.basetypes.Unit.Unit>` such as :class:`~units.Gatherer.Gatherer` and :class:`~units.Hunter.Hunter`.
    
    Food is used by :class:`people <core.basetypes.Person.Person>` as a need upon habitation of any :class:`~core.basetypes.Shelter.Shelter`.
    ...
    * can also be produced by :class:`Farms <units.base.Farm.Farm>` using the tile as a medium.
    """
    def __init__(self):
